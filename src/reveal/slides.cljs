...
(def sponsor-slide
  [:section
   [:img {:src "img/BoiseCodeCampSponsors.jpg"
   ...
   [:div.before-after
    ...
    [:div.after
     [:img {:src "img/firefight-pipes.png"
            :width "256" :height "512"}]]]
   [:aside.notes "Many have covered this and it's fit to be its own talk, so I won't go into deep detail. Design your systems well"]])
